...
function askUserName() {
    username = prompt("Пожалуйста, введите ваше ФИО");
    if (!username || username.trim() === "") {
        askUserName(); // Запрос имени пользователя повторно, если введено пустое значение
    }
}

// Вызов функции запроса имени пользователя перед началом теста
askUserName();
...
function handleEndGame() {
    ...
    fetch('https://express-server-production-7efb.up.railway.app/results', {
        method: 'POST',
        headers: {
